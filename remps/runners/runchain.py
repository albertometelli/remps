...
def trainModelPolicy(
    env, policy, model_approximator, n_trajectories=20, theta=5, epsilon=1e-5
):
    ...
    with U.single_threaded_session() as sess:
        ...
        # first collect data
        # collectData(agent, env, minTheta = 5, maxTheta = 15, bins = 20, episode_count=1, timesteps=400)

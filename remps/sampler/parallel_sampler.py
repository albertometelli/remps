...
class SamplingWorker(Process):
    def __init__(self, policy, env, nb_steps, inputQ, outputQ, n_actions, obs_size):
    ...
    def run(self):
        ...
        with U.single_threaded_session() as sess:
            ...
            sampling_fn = make_sampling_fn(pi, self.env, self.nb_steps, self.n_actions)
...
def make_sampling_fn(pi, env, nb_steps, n_actions):
    # Define the closure
    def sampling_fn():
